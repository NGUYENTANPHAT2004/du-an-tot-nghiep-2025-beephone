              ...
              <div className="advanced-options">
                ...
                <div className="usage-options">
                  <div className="checkbox-group">
                    ...
                    />
                    <label htmlFor="serverWide">
                      Áp dụng cho toàn bộ người dùng (Server-wide)
                    </label>
                  </div>
                  ...
                  <div className="checkbox-group">
                    ...
                    />
                    <label htmlFor="oneTimeUse">
                      Mỗi người dùng chỉ được sử dụng một lần
                    </label>
                  </div>
                </div>
                ...
                <div className="day-restrictions">
                  <h4>
                    Giới hạn ngày trong tuần (không chọn = áp dụng tất cả các
                    ngày)
                  </h4>
