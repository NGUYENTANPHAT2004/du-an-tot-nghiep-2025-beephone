...
const Header = () => {
  ...
  const { getUser, logout, welcomeVoucher, dismissWelcomeVoucher, user } =
    useUserContext();
  ...
  return (
    <header className="header">
      ...
      <div className="header-container">
        {/* Vùng tìm kiếm */}
        <div
          className={`search-container-header ${
              ...
              {username ? (
                <>
                  <button
                    ...
                    className="dropdown-item voucher-item"
                  >
      ...
      {username && getUserId() && (
        <VoucherNotification onVoucherClick={openVoucherModal} />
      )}
